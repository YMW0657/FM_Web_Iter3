  ...
  <div class="answer-model-shadow" v-if="questionShow && !btns[route.query.id]['Y']">
    <div class="answer-model">
      ...
      <div class="btn-group1">
        <button class="btn btn-primary" type="primary" @click="toTargetJump(1)">Try again</button>
        <button v-if="btns[route.query.id]['R']==='Good'" class="btn btn-primary" type="primary" @click="model.jumpTo('/report')"> Report </button>
        <button v-if="btns[route.query.id]['R']==='Bad'" class="btn btn-primary" type="primary" @click="model.jumpTo('/learning')"> Learn More </button>
      </div>
    </div>
  </div>
