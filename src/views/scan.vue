  ...
  <div class="scan">
    <div class="scan-wrapper">
      ...
      <div class="btn-group1">
        <div class="btn" @click="startScanEvent.clearFn">Reset</div>
      ...
      <div class="scan-result">
        <div class="left">
          ...
          <div class="progress">
            <div class="progress-wrapper" :style="{height: startScanEvent.result.FraudPossibility || 0, minHeight:'20px'}">
    ...
    startScan: ()=>{
      ...
      .then(function (response) {
        ...
        if(startScanEvent.result.suspicious_sentence){
          ...
          console.log(startScanEvent.result.email_text);
        }
      }).catch((e)=>{
        console.log(e);
        startScanEvent.result = {};
